...
- **Recent regression evidence:** [`test_condition_label_creation.m`](../tests/test_condition_label_creation.m) exercises the production condition-label section with synthetic data. The researcher reported the suite passing in MATLAB R2024b on 2026-09-21, as recorded in the [validation baseline](../PROJECT_PLAN.md#validation-baseline). This adds regression coverage without changing CD-11 or CD-12.
